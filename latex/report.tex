...
(i) an interpretable station representation based on established temporal traffic indices and their combination across time scales;
(ii) unsupervised clustering to distinguish utilitarian, recreational, and mixed usage patterns;
(iii) a usage-type–specific analysis of weather and public holiday effects.
...
Data quality was assessed by marking incomplete days and potential sensor failures.
Table~\ref{tab:station_quality} summarizes data availability and basic traffic statistics.
