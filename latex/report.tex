...
\icmlaffiliation{first}{Matrikelnummer 12345678, MSc Computer Science}
...
\begin{itemize}
    \item Describe how we identify usage patterns!
    \item k-means with custom features,
    \item and in what we classifly, name each category, also explain why this makes sense, maybe link to related work \citep{american_bike_patterns}
    \item describe each feature include math (with eq. number), link plot, show typical usage pattern PLOT: usage pattern, now cite related work \citep{american_bike_patterns}, and name why we are different
    \item they are rule based, we are more implicit!
\end{itemize}
