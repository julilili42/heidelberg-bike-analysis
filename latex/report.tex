...
Simon Rappenecker and Martin Eichler were responsible for the acquisition and preprocessing of the bicycle counting and weather datasets, including the implementation of data quality and sensor failure checks. Julian Jurcevic and Tarik Eker developed the feature engineering framework, specifically the design of the Double Peak Index (DPI) and seasonal variability metrics. Julian Jurcevic further implemented the sliding-window $k$-means clustering and the probabilistic classification model. The analysis of external factors and the production of all visualizations were performed jointly by all authors. All authors contributed equally to the interpretation of the results and the final drafting of this report.
%\begin{itemize}
%    \item summarize
%    \item limitations
%    \item problems
