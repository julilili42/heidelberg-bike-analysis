...
As centroid ordering is performed in the same feature space used for clustering, these labels
should be interpreted as descriptive summaries of the clusters rather than as an
...
The findings should be interpreted in light of several limitations: the analysis is restricted to 15 stations within a single city, and directional flow information was not considered due to incomplete availability across stations.
