...
\begin{table}[t]
\centering
\caption{Independent temperature and precipitation class definitions.}
...
\vspace{2pt}
{\footnotesize
Classes are defined independently for temperature and precipitation and applied only to the respective analysis.
Empirical quantile thresholds: $q_{33}=10.7^\circ$C, $q_{66}=19.8^\circ$C (temperature),
