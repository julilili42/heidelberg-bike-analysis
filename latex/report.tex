...
Data quality was assessed using a composite quality score that combines multiple metrics.
For each station, we computed: (1) \emph{data availability}, defined as the percentage of days with at least 12 hourly observations; (2) \emph{continuity}, penalizing stations with frequent or prolonged data gaps; (3) \emph{temporal coverage}, rewarding longer observation periods; and (4) \emph{recency}, favoring stations with up-to-date measurements.
Days with fewer than 12 hourly records were classified as missing. Additionally, days with zero total counts at high-traffic stations (median $>$ 500 cyclists/day) were flagged as sensor failures rather than genuine low-traffic days.
