...
Using hourly counting data from 15 stations in Heidelberg (Figure~\ref{fig:station_map}), we first derive features to quantify traffic shapes across daily, weekly, and seasonal timescales.
...
\begin{itemize}[noitemsep, topsep=1pt]
    ...
    \item \emph{Mixed}: Dual-purpose locations exhibiting both utilitarian and recreational characteristics.
\end{itemize}
% Why k = 3?
...
\todo{Explaination why these features were choosen?}
\todo{Why is symmetry and distance used in DPI?}
% DPI
