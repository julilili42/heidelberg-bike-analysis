...
\todo{Figure out what time window of data was used in analysis}
...
S3  & Ernst-Walz-Brücke    & 6179 & 3344 & 101 & 100.0 \\
S4  & Gaisbergstraße    & 4239 & 1651 &  57 &  94.7 \\
S5 & Schlierbacher Landstr.&  786 &  389 &  20 &  60.2 \\
S6 & Ziegelhäuser Landstr. &  872 &  389 &  20 &  58.3 \\
S7  & Rohrbacher Str.   & 2426 & 1251 &  48 &  95.7 \\
S8  & Theodor-Heuss-Br. & 7902 & 2865 & 108 & 100.0 \\
S9 & Mannheimer Str.   & 1964 &  845 &  28 &  83.2 \\
S10  & Ernst-Walz-Brücke alt& 3240 & 1517 &  75 &  99.9 \\
...
\todo{Explaination why k-means was chosen?}
\todo{Explaination why k = 3 was chosen?}
% DPI
...
The strongest temperature sensitivity is observed for mixed stations, particularly on weekends, where high-temperature days lead to increases exceeding 100\% relative to the low-temperature baseline.
Utilitarian stations show moderate increases, while recreational stations exhibit comparatively smaller relative gains.
...
Precipitation has a consistently negative effect on bicycle traffic for all usage types (Table~\ref{tab:precipitation_effect}).
Mixed stations exhibit the strongest declines, particularly on weekends.
Recreational and utilitarian stations show similar, but less pronounced reductions.


Overall, weather sensitivity varies by usage type and reflects underlying trip purposes.
Utilitarian stations are dominated by weather-resilient commuting traffic, while mixed stations combine obligatory and discretionary trips and therefore exhibit stronger weather responses.
...
Public holidays substantially reduce bicycle traffic across all usage types
(Table~\ref{tab:holiday_effect}), with the strongest declines observed at
recreational and utilitarian stations, while mixed stations are less affected.
Beyond volume effects, holidays also alter traffic structure
(Figure~\ref{fig:holiday_shape}): weekday commuting peaks weaken
($\Delta$DPI $< 0$) and usage patterns shift toward weekend-like profiles
($\Delta$WSD $< 0$), with heterogeneous responses across station types.
